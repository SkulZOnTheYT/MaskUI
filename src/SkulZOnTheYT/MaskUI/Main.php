	...
	$form = new SimpleForm(function (Player $sender, int $data = null){
		...
		case 1:
		  ...
		  $sender->getWorld()->addSound($sender->getPosition(), new EndermanTeleportSound());
		    ...
		    $typeInfo = MobHeadType::WITHER_SKELETON();
